...
# redirect std out
log_name = '%s-%s-%s-%s-%s-%s-%s.log' % (args.dataset, args.teacher_arch, args.arch, args.mixup_method, args.calibration_method, str(args.soft_constraint_ratio), str(args.temperature))
