...
__all__ = ['ResNet', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet50', 'resnet110', 'resnet1202']
...
def resnet50(num_classes=10):
    return torch.hub.load('pytorch/vision:v0.6.0', 'resnet50', num_classes=num_classes, pretrained=False)
